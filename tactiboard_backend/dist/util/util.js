...
exports.getJaDateOneDayAgoString = exports.getJaDateString = void 0;
...
const getJaDateOneDayAgoString = () => {
    var _a, _b, _c, _d, _e, _f;
    const date = new Date();
    date.setDate(date.getDate() - 1); // 1日前の日付を取得
    // 日本時間に変換
    const options = {
        timeZone: 'Asia/Tokyo',
        year: 'numeric',
...
exports.getJaDateOneDayAgoString = getJaDateOneDayAgoString;
