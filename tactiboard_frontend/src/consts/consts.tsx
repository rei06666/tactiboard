export const APP_NAME = "Tactiboard";

export const MESSAGES = {
  LOGIN_SUCCESS: { type: "success", text: "Login succeeded!" },
  LOGIN_FAILURE: { type: "error", text: "login failed" },
  SIGNUP_SUCCESS: { type: "success", text: "Signup succeeded!" },
  SIGNUP_FAILURE: { type: "error", text: "Signup failed" },
