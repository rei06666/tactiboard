  ...
  return (
    <div className="min-h-screen bg-base-100">
      <div className="mx-auto max-w-lg py-[15vh]">
        <div>
          <div className="font-monoton text-center text-5xl p-2">
            {APP_NAME}
          </div>
        </div>
        ...
        {formName === "login" && (
          <LoginForm setMessage={setMessage} setFormName={setFormName} />
        )}
        {formName === "forgot" && (
        ...
        {formName === "signup" && (
          <SignUpForm setMessage={setMessage} setFormName={setFormName} />
        )}
